                  ...
                  children: [
                    TextButton(
                        ...
                        child:  TextButton(child: const Text(
                          ...
                          onPressed: () {
                           Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const TrackerBottonBar()));
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          _currentPage == widget.pages.length - 1
                              ? "start"
                              : "weiter",
                          style:  _currentPage == widget.pages.length - 1?const TextStyle(color: Colors.yellow, fontSize: 25):
